...
public class ScannerEx_01 {
	...
	public static void main(String[] args) {
		...
		Scanner scan = new Scanner(System.in);
			 ...
			 *  
			 *  예외가 발생할 것 같은 코드들을 try{} block에 작성을 하고 실행을 했을때
			 *  만약 exception이 발생했을때 catch 명령이 exception을 잠시 잡고있는
			 *  상황이 된다.
			 *  catch{} block exception 발생했을때 사용자에게 알려주는 메시지 등을
			 *  보여주거나 다른 코드를 사용하여 처리할 수 있으면 처리를 하고 코드가 다시
			 *  진행되도록 한다.
			 *  
			 */
			try {
