...
public class InputServiceV2 {
	...
	public Integer inputValue(String title, int start, int end) {
		...
		while (true) {
			...
			// return 해준값이 null 이 아니면 유효성 검사 수행
			if (intNum != null) { // != null값이 아니면
				// 유효성 검사를 통과하지 못하면
	...
	public Integer inputValue(String title) {
		...
		/*
		 * exception이 발생했을때 사용자에게 안내 메시지를 보여주고 다시 입력을 받도록 하기 위한 선 조치
		 */
		while (true) {
