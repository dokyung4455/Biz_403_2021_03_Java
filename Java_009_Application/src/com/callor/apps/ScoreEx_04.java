...
/*
 *  객체 == 변수
 *  객체와 변수는 선언, 생성, 사용방법이 매우 유사핟.
 *  객체가 만들어진다 == 기억장치 어딘가에 저장소가 만들어진다, 마치 변수처럼
 *  객체는 항상 연결연산자(점 연산자)가 있다.
 *  객체는 객체 자체만으론 어떤 역할을 수행하지 않는다.
 *  다만, method에 매개변수로 전달할때는 거의 변수와 같이 사용이된다.
 */
public class ScoreEx_04 {
	
	public static void main(String[] args) {
		
		// 객체 이름을 지을때 클래스 이름의 첫글자를 소문자로하여 그대로 사용하는게 일반적
		...
		*/
		 ...
		 * 
		 * 기본 변수와 사용법이 같은 클래스
		 * wrapper class : 기본 변수를 감싸고 기능을 확장한다.
		...
		// method를 호출하여 return한 결과를 또다른 method에 매개변수로 전달하는 토딍
