...
public class App_05 {
	...
	public static void main(String[] args) {
		...
		// ssV5 객체를 선언하고 생성자(new)를 호출하여 인스턴스화 하는 코드
		...
		// 코드가 모드 정상 종료되거나 아니면 중간에 return 명령문을 만나면 System.out("입력...")
		// 명령문이 이어서 실행됨
		ssV5.makeScores();
		System.out.println("입력업무 중단 - ");
		
		//  static method
		// method에 static keyword가 부착되면 객체를 생성하는 절차 없이
		// method를 직접 호출할 수 있다.
		// 클래스.method()
		// static method는 프로젝트가 시작됨과 동시에 자동으로 만들어져 언제든지 호출할 수 있다.
		// 다만, 지금 사용하지 않더라도 항상 메모리에 상주하고 있기 때문에 경우에 따라
		// 불필요하게 메모리를 차지하여 메모리낭비를 불러올 수 있다.
