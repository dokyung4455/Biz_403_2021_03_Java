...
public class String_01 {
	...
	public static void main(String[] args) {
		...
		char char1 = 'A'; // 문자 변수 : 알파벳 한글자만 저장
		String str1 = "대한민국 만세"; // 문자열 변수 : 문자들의 묶음 변수
		// 문자는 알파벳으로 읽히지만 변수에 저장될때는 정수형 ASCII 코드값으로 저장된다
		// 그래서 정수와 사칙연산이 가능하다
		...
		// str1에 담긴 문자열을 space(" ")를 기준으로 잘라서 str3 배열에 저장하라 " " 사이에 기준이 들어간다
