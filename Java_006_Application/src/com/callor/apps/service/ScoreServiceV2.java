...
public class ScoreServiceV2 {
	...
	// 클래스 영역에 선언된 변수
	// 누군가 이 클래스를 사용하여 인스턴스를 생성하면 자동으로 예약이 되는 변수
	// 자동으로 예약이 되는 변수들
	// 인스턴스(영역) 변수
	// 클래스의 멤버변수
	...
	public void intValue() {
		...
		// Random 클래스를 사용하여 rnd 인스턴스 변수 생서
		rnd = new Random();
		intKor = new int[10];
	...
	// Random 클래스를 사용하여 생성된 rnd 인스턴스의 nextInt() method를 호출하여
	//1~100까지 난수를 만들고 각 점수배열에 저장하기 
